...
class SMDInventory(object):
    ...
    cached for repeated checks, stored both as overall inventory and seperate group types to allow
    ...
    def partitions(self):
        if not hasattr(self, '_partitions'):
            ...
            for partition in data:
                partitions[partition['label']] = set(partition.get('members', {}).get('ids', []))
